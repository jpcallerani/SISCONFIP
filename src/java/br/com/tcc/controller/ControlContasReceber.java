 ...
 * @author Jp
 */
public class ControlContasReceber {
    ...
    public List<TblContaPagarReceber> contasUsuario(TblUsuario usuario) {
        ...
        parameters.add(Restrictions.eq("idTipoMovimento", new TblTipoMovimento(2)));
    ...
    public String RecebeConta(TblContaPagarReceber contaPagRec) {
        ...
        if (this._erro.equals("")) {
            this._erro = "Valor recebido na conta \"" + contaPagRec.getIdConta().getNome() + "\" com sucesso.";
        }
        return this._erro;
    }
