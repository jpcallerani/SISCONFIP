 ...
 * @author Jp
 */
@ManagedBean(name = "ManageRelatContasRec")
@RequestScoped
public class ManageRelatContasRec {
    //
    ...
    public void init() throws IOException {
        _tblContasPag = new ControlRelatContasRec()
                .procuraContasPagas(_usuario, new TblTipoMovimento(2), _dt_dataVencimentoIni, _dt_dataVencimentoFim, _dt_dataPagamentoIni, _dt_dataPagamentoFim, this._vencidas, this._vencer, this._pagas);
        Object key;
    ...
    public String retornaSaldo() {
        return Utils.moneyFormat(new ControlRelatContasRec().retornaSaldo(_tblContasPag));
    }
    ...
    public String retornaSaldoPag() {
        return Utils.moneyFormat(new ControlRelatContasRec().retornaSaldoPag(_tblContasPag));
    }
