 ...
 * @author Jp
 */
@ManagedBean(name = "ManageTabRelatContasPag")
@RequestScoped
public class ManageTabRelatContasPag {
    ...
    public ManageTabRelatContasPag() {
        _groupBy = "Categoria";
    ...
    public void abreRelatório() {
        ...
        context.execute("open_new_window('/TCC/faces/resources/relatorios/relatContasPag.xhtml?" + parameters + "', 'Relat')");
